...
const IntegrationScorecard = lazy(() => import("./pages/portal/IntegrationScorecard"));
...
// Additive only. Every route below is new; none replaces an existing one.
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/portal/retirement-readiness-score" component={gated(RetirementReadinessScore, "/portal/retirement-readiness-score")} />
      ...
      <Route path="/portal/captive-insurance-planner" component={gated(CaptiveInsurancePlanner, "/portal/captive-insurance-planner")} />
      <Route path="/portal/organism-health" component={gated(OrganismHealthReport, "/portal/organism-health")} />
      <Route path="/portal/risk-tolerance-profiler" component={gated(RiskToleranceProfiler, "/portal/risk-tolerance-profiler")} />
      ...
      <Route path="/portal/key-person-insurance" component={gated(KeyPersonInsurance, "/portal/key-person-insurance")} />
      <Route path="/portal/opportunity-zone-planner" component={gated(OpportunityZonePlanner, "/portal/opportunity-zone-planner")} />
      ...
      <Route path="/portal/crypto-tax-strategy" component={gated(CryptoTaxStrategy, "/portal/crypto-tax-strategy")} />
      ...
      <Route path="/portal/succession-planning-hub" component={gated(SuccessionPlanningHub, "/portal/succession-planning-hub")} />
      ...
      <Route path="/portal/opportunity-zone-tracker" component={gated(OpportunityZoneTracker, "/portal/opportunity-zone-tracker")} />
      ...
      <Route path="/portal/international-tax-planner" component={gated(InternationalTaxPlanner, "/portal/international-tax-planner")} />
      ...
      <Route path="/portal/charitable-lead-trust-planner" component={gated(CharitableLeadTrustPlanner, "/portal/charitable-lead-trust-planner")} />
      ...
      <Route path="/portal/client-financial-health-score" component={gated(ClientFinancialHealthScore, "/portal/client-financial-health-score")} />
