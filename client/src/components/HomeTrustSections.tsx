...
export const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "What are the proprietary engines?", a: "Fifty-seven planning technologies, each documented with a drafted patent application, built to coordinate strategies that most tools treat as separate islands. No application has been filed with the USPTO yet, so no patent protection exists. You won't find them offered anywhere else." },
