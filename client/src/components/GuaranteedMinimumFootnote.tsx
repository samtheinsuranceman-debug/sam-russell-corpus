  ...
  if (compact) {
    return (
      <div className="flex items-start gap-2 px-3 py-2 rounded-md bg-amber-500/5 border border-amber-500/20 text-xs text-amber-200/80 mt-2">
        ...
        <span>
          <strong className="text-amber-300/90">Non-Guaranteed Projection.</strong>{" "}
          Values shown assume a crediting rate you set and are{" "}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="text-amber-200/80 space-y-1.5">
            <p>
              All values shown in this projection table are <strong className="text-amber-300">non-guaranteed projected values</strong> based
              on an <strong className="text-amber-300">assumed crediting rate</strong> you set. They are not a carrier illustration.
