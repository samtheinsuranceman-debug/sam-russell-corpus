...
export default function ManagedAuthGuard({ children, returnPath }: { children: ReactNode; returnPath: string }) {
  ...
  if (!isAuthenticated) {
    return (
      <main id="main-content" tabIndex={-1} className="min-h-screen grid place-items-center bg-[radial-gradient(circle_at_20%_10%,rgba(16,185,129,.24),transparent_34%),linear-gradient(145deg,#04100c,#071411_55%,#050b0a)] px-6 text-emerald-50 outline-none">
        <section className="w-full max-w-lg rounded-3xl border border-emerald-400/20 bg-black/35 p-8 shadow-[0_28px_90px_rgba(6,95,70,.35)] backdrop-blur-xl">
          ...
          <a
            ...
            className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-3 font-semibold text-white shadow-lg shadow-emerald-950/40 transition duration-200 hover:bg-emerald-800 active:scale-[0.97]"
          >
