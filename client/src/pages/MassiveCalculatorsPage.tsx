...
const categories = {
  'RETIREMENT & INCOME': [
    ...
    { slug: 'ecological-drivers', name: 'Retirement Drivers', desc: 'Key factors driving your retirement readiness score.' },
    { slug: 'income-gap', name: 'Income Gap Analyzer', desc: 'Identify and close gaps in your retirement income plan.' },
    ...
    { slug: 'retirement-projection', name: 'Income Calculator', desc: 'Calculate total retirement income from all sources.' },
  ],
  'TAX & ESTATE': [
    ...
    { slug: 'estate-tax', name: 'Estate Planning', desc: 'Estate tax minimization and wealth transfer strategies.' },
    { slug: 'hot-income', name: 'Hot Income', desc: 'Identify and optimize high-tax income sources.' },
    { slug: 'tax-combos', name: 'Tax Arbitrage', desc: 'Exploit tax rate differentials across time and accounts.' },
    { slug: 'tax-brackets', name: 'Dynamic Tax', desc: 'Real-time tax bracket modeling with scenario comparison.' },
  ],
  'IUL & INSURANCE': [
    { slug: 'iul-engine', name: 'IUL Projection', desc: 'Advanced Indexed Universal Life policy projections.' },
    ...
    { slug: 'fia-top10', name: 'FIA Collateral', desc: 'Fixed Indexed Annuity as collateral strategies.' },
    { slug: 'trusts', name: 'ILIT Estate', desc: 'Irrevocable Life Insurance Trust planning.' },
  ],
  'REAL ESTATE': [
  ...
  'LIFE EVENTS': [
    ...
    { slug: 'multi-gen-wealth', name: 'Newborn Launchpad', desc: 'Financial planning from birth to independence.' },
    { slug: 'trusts', name: 'Special Needs', desc: 'Financial planning for special needs dependents.' },
    { slug: 'long-term-care', name: 'Caregiver Impact', desc: 'Financial impact analysis of caregiving responsibilities.' },
  ],
  'ADVANCED STRATEGIES': [
    { slug: 'time-machine', name: 'Time Machine', desc: 'Historical "what if" scenario simulation.' },
    { slug: 'strategy', name: 'Strategy Lab', desc: 'Experiment with financial strategies using interoperable tools.' },
    { slug: 'index-backtester', name: 'Index Backtester', desc: 'Backtest any index strategy against historical data.' },
    { slug: 'crypto-corner', name: 'Crypto Cycle', desc: 'Cryptocurrency cycle analysis and allocation.' },
    { slug: 'tax-combos', name: 'Oil & Gas', desc: 'Oil and gas royalty income and tax optimization.' },
  ],
  'LIFESTYLE & PROTECTION': [
    { slug: 'inflation', name: 'Inflation Analysis', desc: 'Model inflation impact on your financial plan.' },
    { slug: 'medicare-irmaa', name: 'Healthcare Bomb', desc: 'Healthcare cost explosion modeling and protection.' },
    { slug: 'myga-fixed-rate', name: 'MYGA Waterfall', desc: 'Multi-Year Guaranteed Annuity laddering strategy.' },
  ],
};
          ...
          return (
            <div key={category} className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filtered.map((calc) => (
                  <Link key={calc.name} to={`/portal/${calc.slug}`}
