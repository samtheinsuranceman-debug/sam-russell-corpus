  ...
  return (
    <AppShell title="Map" subtitle="How this site is arranged">
      <div className="p-4 text-sm opacity-80">
        <p>The map is open above: tabs, the hubs under them, every page, and the deeper pages under each page. Close it with the X in its top-right corner; pages you have visited stay green on every login.</p>
