      ...
      <div className="bg-[#1e293b] rounded-lg shadow-lg p-6">
        {activeTab === 0 && (
          <div>
            ...
            {/* Estate exemption $15M (2026), indexed, no sunset: P.L. 119-21 § 70106 amending IRC § 2010(c)(3), https://www.congress.gov/119/plaws/publ21/PLAW-119publ21.pdf; Rev. Proc. 2025-32, https://www.irs.gov/pub/irs-drop/rp-25-32.pdf (read 23 Sep 2026). Was "$13.61M (2024) … sunset to ~$7M in 2026". */}
            <p className="mb-4">
              A trust is a legal arrangement where a grantor transfers assets to a trustee, who manages them for the benefit of designated beneficiaries. Trusts can be revocable, allowing the grantor to alter terms during their lifetime, or irrevocable, locking in the structure for maximum tax and asset protection benefits. The distinction between grantor, trustee, and beneficiary is critical: the grantor creates and funds the trust, the trustee administers it, and beneficiaries receive the benefits per the trust’s terms. Trusts matter for wealth protection because they can remove assets from your taxable estate, reducing exposure to estate taxes, which exempt $15 million per individual in 2026, indexed for inflation and made permanent by the One Big Beautiful Bill Act (P.L. 119-21) — there is no scheduled 2026 sunset.
            </p>
            <p className="mb-4">
            ...
            <p>
              At Russell Capital Systems, our AI Strategy Engine evaluates your estate size, tax exposure, and family needs to recommend the ideal trust structure. We model current law and "what if Congress lowers the exemption" scenarios to ensure your plan remains robust under changing laws. Partner with us to craft a trust strategy that protects your wealth and aligns with your long-term vision.
            </p>
          </div>
        )}
        {activeTab === 1 && (
