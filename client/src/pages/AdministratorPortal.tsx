...
export default function AdministratorPortal() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#060f20] p-6 text-white">
      <Card className="w-full max-w-xl border-emerald-400/20 bg-slate-950/80">
        ...
        <CardContent className="space-y-5 text-slate-300">
          ...
          {loading ? <p>Checking managed session…</p> : !isAuthenticated ? (
            ...
            <Link href="/portal/team-management"><Button>Open Team Management <ArrowRight className="ml-2 h-4 w-4" /></Button></Link>
          )}
        </CardContent>
      </Card>
    </div>
