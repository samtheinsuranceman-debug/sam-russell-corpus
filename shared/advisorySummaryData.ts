...
export const TAB_SUMMARIES: TabSummary[] = [
  ...
  },
  {
    ...
    categoryColor: "amber",
    icon: "Landmark",
    // Exemption $15M (2026), indexed, no sunset — P.L. 119-21 § 70106 amending IRC § 2010(c)(3), https://www.congress.gov/119/plaws/publ21/PLAW-119publ21.pdf; Rev. Proc. 2025-32, https://www.irs.gov/pub/irs-drop/rp-25-32.pdf (read 23 Sep 2026). The "2026 sunset" claims below were removed.
    useCase: "Models estate tax exposure and strategies to minimize it. Shows the impact of the current exemption ($15M per person in 2026, P.L. 119-21).",
    utility: "Quantifies estate tax liability and shows how life insurance can offset it. Essential for HNW planning.",
    uniqueProblem: "Clients don't realize their estate may be taxable above the $15M exemption, or under state estate taxes with far lower thresholds. This makes the problem visible and the solution clear.",
    resultConsistency: "High — estate tax calculations are based on current law (P.L. 119-21 made the exemption permanent, indexed).",
    hiddenAdvantages: [
      "Compares this year with 2026 under current law",
    ...
    differentiation: "Models the exemption under current law and shows insurance-based solutions.",
    ratings: { functionality: 10, efficiency: 10, predictability: 10, complexity: 9, comprehension: 10, importance: 10 },
    experienceLevel: ["intermediate", "advanced"],
    goalTags: ["Tax planning for HNW clients"],
