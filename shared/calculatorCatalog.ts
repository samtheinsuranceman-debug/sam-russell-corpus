...
export const CALCULATORS: readonly CalculatorEntry[] = [
  ...
  { path: "/portal/income-for-life", name: "Lifetime Income from a Roth-Held Annuity", category: "retirement-income", featured: true,
  ...
  { path: "/portal/iul-vs-roth", name: "IUL Life Insurance vs Roth", category: "insurance",
    blurb: "Life insurance (IUL) and a Roth IRA compared honestly: limits, charges, when each is tax-free, and where the Roth wins.",
  ...
  { path: "/portal/early-cash-value", name: "Early Cash Value", category: "insurance",
    blurb: "Which surrender-charge schedule governs a loan, a withdrawal, a 1035 and a full surrender, and whether the early-cash-value rider changes any of them.",
    engine: "shared/earlyCashValue.ts",
    keywords: ["early cash value", "surrender charge", "surrender value enhancement", "rider", "1035", "walk-away", "ecv"] },
  { path: "/portal/credit-line-sequencing", name: "Credit-Line Sequencing", category: "insurance",
    blurb: "Which cards to open, in what order, how much 0% capital that places as premium, and the payoff that clears every line before its promo ends.",
    engine: "shared/creditLineSequencingEngine.ts",
    keywords: ["credit line", "0% apr", "intro apr", "card sequencing", "5/24", "premium funding", "credit card", "balance transfer"] },
  ...
  { path: "/portal/infinite-banking", name: "Policy Loan Cycle", category: "real-estate", featured: true,
