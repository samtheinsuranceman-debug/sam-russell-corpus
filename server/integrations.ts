...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: "deepgram", name: "Deepgram", category: "voice", mode: "runtime", purpose: "Speech to text for recorded voice sessions", envKeys: ["DEEPGRAM_API_KEY"], optionalKeys: ["TRANSCRIPTION_PROVIDER"], wiredTo: "POST /api/voice/transcribe (Thomas Goldman long voice sessions)" },
  ...
  { id: "runway", name: "Runway", category: "voice", mode: "runtime", purpose: "Generative video from a prompt or a still image (RUNWAY_API_KEY also accepted)", envKeys: ["RUNWAYML_API_SECRET"], optionalKeys: ["RUNWAY_API_KEY"], docs: "https://docs.dev.runwayml.com/", wiredTo: "videoGen router (owner only)" },
  { id: "luma", name: "Luma AI", category: "voice", mode: "runtime", purpose: "Generative video, alternative to Runway (LUMA_API_KEY also accepted)", envKeys: ["LUMAAI_API_KEY"], optionalKeys: ["LUMA_API_KEY"], wiredTo: "videoGen router (owner only)" },
  { id: "voyage", name: "Voyage AI", category: "ai", mode: "runtime", purpose: "Text embeddings for semantic search", envKeys: ["VOYAGE_API_KEY"], optionalKeys: ["VOYAGE_MODEL"], docs: "https://docs.voyageai.com/docs/embeddings", wiredTo: "server/voyage.ts client only; no feature embeds text yet" },
