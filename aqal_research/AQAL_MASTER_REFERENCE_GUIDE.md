...
| 4 | Stellate Ganglion Block | Adjusted mean CAPS-5 score change = -12.6 points (95% CI, -15.5 to -9.7 points) vs -6.1 points for sham (P = .01) | Rae Olmsted, K. L., Bartoszek, M., Mulvaney, S., McLean, B., Turabi, A., Young,  | Physiological hyperarousal, psychologica |
...
| 12 | Creative arts therapies (drama therapy and psychodrama) for trauma | SMD = -1.98, 95% CI [-3.8, -0.16], k = 7 studies | Wang, J., Zhang, B., Yahaya, R., & Abdullah, A. B. (2025). Colors of the mind: a | Emotional, Interpersonal, Cognitive |
...
| Forgiveness interventions | Δ+ = 0.56, 95% CI [0.43, 0.68] | Wade, N. G., Hoyt, W. T., Kidwell, J. E. M., & Worthington, E. L. (201 | Not mapped |
| Clinical Hypnosis | d = 0.60, p ≤ .001, k = 40 pos | Milling, L. S., Valentine, K. E., LoStimolo, L. M., et al. (2021). Hyp | Not mapped |
...
| Social Prescribing and Community Referral for loneliness | moderate reductions in lonelin | Wang, Y., Xu, Y., Gao, L., & Bai, X. (2026). Impact of social prescrib | Not mapped |
| Polyvagal exercises and vagal toning for anxiety and emotional regulation | SMD = -0.53, 95% CI [-0.74, -0 | Lin, Z., Wang, D., Nie, Y., Tan, C., & Liu, Z. (2026). Transcutaneous  | Emotional Regulation, Body Awarenes |
...
| Float tanks and sensory deprivation (REST) for anxiety and pain | d = 0.65, k = 27 studies | van Dierendonck, D., & te Nijenhuis, J. (2005). Flotation restricted e | Emotional Regulation, Body Awarenes |
...
| Trauma-Focused Cognitive Behavioral Therapy (TF-CBT) | g = 1.14, 95% CI [0.97, 1.30] | Thielemann, J. F. B., Kasparik, B., König, J., Unterhitzenberger, J.,  | Emotional Regulation, Trauma Integr |
...
| Implementation intentions (if-then planning) for behavior change | d = 0.65, k = 94 studies | Gollwitzer, P. M., & Sheeran, P. (2006). Implementation intentions and | volitional control, cognitive flexi |
...
| Acceptance-based approaches for chronic illness and disability adjustment | d = 0.50 (medium effect size)  | Ye, L., Li, Y., Deng, Q., Zhao, X., Zhong, L., & Yang, L. (2024). Acce | Cognitive, Emotional, Physical |
...
| Gestalt Empty Chair technique for unfinished business and grief | d = 0.40 | Pascual-Leone, A., & Baher, T. (2023). Chairwork in individual psychot | Not mapped |
...
| Forest bathing (Shinrin-yoku) | MD = -0.08 μg/dl [95% CI -0.11 | Antonelli, M., Barbieri, G., & Donelli, D. (2019). Effects of forest b | Emotional Regulation, Body Awarenes |
...
| Cognitive Behavioral Coaching | g = 0.499, k = 26 studies | Tomoiagă, C., & David, O. (2023). Is cognitive-behavioral coaching an  | Cognitive, Emotional |
...
| Binaural beats and auditory stimulation for focus and relaxation | g = 0.45, k = 22 studies | Garcia-Argibay, M., Santed, M. A., & Reales, J. M. (2019). Efficacy of | Cognitive, Emotional |
...
| Peer support and lived experience mentoring for recovery | SMD = 0.29, 95% CI [0.13, 0.45 | Jambawo, S. M., Owolewa, R., & Jambawo, T. T. (2024). The effectivenes | LR (Lower Right) - Social/Interpers |
...
| Mathematical intelligence line | WELL-ESTABLISHED | OVERLAPPING (with Logical intelligence l | Woodcock-Johnson IV (Quantitative Knowledge/Gq), WAIS-IV (Ar |
...
| Philosophical intelligence line | WEAK SUPPORT | OVERLAPPING (with Logical and Existentia | Defining Issues Test (moral reasoning), Watson-Glaser Critic |
...
| Adaptive intelligence line | SUPPORTED | OVERLAPPING (with Resilient, Cognitive F | Bar-On EQ-i (Adaptability scale), Cognitive Flexibility Inve |
...
- Defensibility: YES
- Recommended framing: Frame Tactical intelligence as 'Action-State Orientation' or 'Action Regulation'—the volitional capacity to initiate, shield, and execute goal-directed actions efficiently. Ground it in Kuhl's Action Control Theory and Frese's Action Regulation Theory, distinguishing it from strategic planning by focusing on the immediate cognitive regulation required to overcome hesitation and execute tasks.
...
- Psychometric data: Internal consistency typically ranges from acceptable to good (e.g., Cronbach's alpha .70-.85 across subscales). Test-retest reliability for related measures like PSOC is high (r = .81 over 2 months).
- Defensibility: PARTIALLY (with caveats)
...
- Psychometric data: Flirting Styles Inventory shows high reliability (Cronbach's α > 0.80). Mating Intelligence Scale shows high omega coefficient and high-reliability coefficients for the total scale and subscales in some validations (e.g., Najarpourian & Samavi, 2019).
- Defensibility: PARTIALLY (with caveats)
...
| 2/3 | Self-protective | Opportunist | 8% | **5%** | Rooke & Torbert 2005 | YES (SCTi/MAP) |
| 3 | Conformist | Diplomat | 12% | **12%** | Rooke & Torbert 2005 | YES (SCTi/MAP) |
| 3/4 | Self-conscious | Expert | 30% | **38%** (ERROR) | Rooke & Torbert 2005 | YES (SCTi/MAP) |
| 4 | Conscientious | Achiever | 30% | **30%** | Rooke & Torbert 2005 | YES (SCTi/MAP) |
| 4/5 | Individualist | Individualist | 10% | **10%** | Rooke & Torbert 2005 | YES (SCTi/MAP) |
| 5 | Autonomous | Strategist | 4% | **4-4.9%** | Cook-Greuter 2004 | YES (SCTi/MAP) |
| 5/6 | Construct-aware | Alchemist | <2% | **1%** | Rooke & Torbert 2005 | PARTIALLY (small samples) |
...
|-----------|---------|-------------|
| Complementary Mode (65/35 weights) | MOSTLY SOUND | Reasonable but weights are arbitrary; no empirical basis for 65/35 specifically |
| Resonance Mode (60/40 weights) | MOSTLY SOUND | Homophily research supports similarity matching |
| Thresholds (1/3 split, 0.82 bar) | MOSTLY SOUND | 0.82 is high; consider 0.70 for broader matching |
...
| 2 | Stage 3/4 Expert: 30% → 38% | stageFramework.ts | IMMEDIATE |
...
## 38. Perplexity Pass 31: Complete Operational Toolkit Summary (August 6, 2026)

### System Components Delivered:
1. **Crisis Scoring Algorithm** — 0-41 point scale with 4 priority tiers
2. **Intake Form Template** — 11 sections covering demographics, financial, pressures, crisis, psychology, ecology, safety, intervention plan, metrics, escalation, follow-up
3. **Dashboard Data Structure** — Real-time tracking across 4 tiers with KPIs
4. **Staffing Model** — 17 FTE coaches for 400 cases at evidence-based ratios
5. **Budget Model** — $1.25M/year total, $260/client/month, $189/client/month profit at $449 pricing

### 5 Standard Protocols (Final List):
1. Triage crisis, then build one repeatable daily win
2. Stabilize sleep, food, transport, then money
3. Use the strongest trait to support the weakest moment (strength-lever)
4. Remove friction from the most critical behavior first
5. Pause heavy change until safety is restored, then restart small

### 5 Success Metrics:
1. Sleep 6+ hours for 5 of 7 nights
2. No new crisis events (eviction notice, job warning, relationship fight)
3. One bill paid or payment plan arranged
4. One supportive conversation completed
5. Morning routine done 3+ days
...
2. Missed 2+ critical payments
3. Relationship rupture or domestic conflict
4. Substance use >3 drinks/day or any drug use
5. Can't get out of bed for 2+ days

### Key Performance Indicators (Platform-Level):
- Crisis score reduction rate (target: 20% reduction in 30 days)
- Tier graduation rate (target: 60% move down one tier in 60 days)
- Escalation rate (target: <10% return to higher tier)
- Coach utilization (target: 80-90% caseload capacity)
- Client retention (target: 85% still engaged at 90 days)

### Note on Data Source:
The 600 scenarios (200 original + 400 fresh) are SYNTHETIC test data generated by Perplexity — useful as algorithm test cases and framework illustrations, NOT as clinical evidence. The framework structure (monsters, protocols, metrics, escalation triggers) is the valuable output. The individual scenarios are permutations of variables we defined.
