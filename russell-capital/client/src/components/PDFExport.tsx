...
<head>
  <meta charset="utf-8">
  <title>${title} — Russell Capital Solutions™</title>
  <style>
...
<body>
  ...
  <div class="confidential">
    CONFIDENTIAL — Prepared exclusively for ${cp.name}. This document contains proprietary tax optimization strategies and should not be distributed without authorization from Russell Capital Solutions™.
  </div>
