...
import { Sparkles, Presentation, ChevronRight, ChevronLeft, Download, Eye, Maximize2, Minimize2, Loader2, BarChart3, Shield, DollarSign, TrendingUp, Clock, FileText, Copy, Zap, Target, PieChart, Scale, Lock, Layers, FileDown, Save, Search, Plus, Trash2, ArrowRight, Icon} from 'lucide-react';
...
export default function AISlideGenerator() {
  ...
  const handleExportMarkdown = () => {
    if (!slides.length) return;
    let md = `# Russell Capital Solutions™ Presentation\n\n`;
  ...
  const handleExportHTML = () => {
    if (!slides.length) return;
    let html = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Russell Capital Solutions™ Presentation</title>
<style>
...
@media print{.slide{min-height:auto;padding:2rem}.brand{display:none}}
    ...
    html += `<div class="brand">Russell Capital Solutions™</div></body></html>`;
    ...
    return (
      <div className="fixed inset-0 z-50 bg-[#0d1a2e] flex flex-col">
        ...
        <div className="px-6 py-2 bg-black/40 border-t border-[#12233e] flex items-center justify-between">
          <p className="text-[#7a95b8] text-xs">Russell Capital Solutions™ — Confidential</p>
