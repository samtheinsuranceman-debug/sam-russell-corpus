...
import { Compass, ChevronRight, Clock, Star, ArrowRight, CheckCircle2, User, Target, Users, Sparkles, RotateCcw, MapPin, Filter, Search, ChevronDown, Edit, FileText, Heart, Info, Layout, Navigation, Plus, Settings, Type } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a111c] text-[#c8d8ec] p-6 font-sans">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-wrap gap-4 p-4 bg-[#0d1a2e] rounded-xl border border-[#12233e]">
          ...
          <input type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Search..." className="p-2 bg-[#0d1526] rounded text-white" />
          ...
          <select value={activeTab} onChange={(e) => setActiveTab(e.target.value)} className="p-2 bg-[#0d1526] rounded text-white">
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute top-full left-0 bg-[#0d1526] border border-[#1e3a5f] rounded mt-1 p-2 w-32 z-10">
                <div className="p-1 hover:bg-[#162a4a] cursor-pointer">Option 1</div>
                <div className="p-1 hover:bg-[#162a4a] cursor-pointer">Option 2</div>
              </div>
            )}
          </div>
        ...
        <div className="flex flex-wrap gap-4 p-4 bg-[#0d1a2e] rounded-xl border border-[#12233e]">
          ...
          <select value={sortBy} onChange={(e) => setSortBy(e.target.value as any)} className="p-2 bg-[#0d1526] rounded text-white">
          ...
          <select value={pageSize} onChange={(e) => setPageSize(parseInt(e.target.value))} className="p-2 bg-[#0d1526] rounded text-white">
          ...
          <input type="date" className="p-2 bg-[#0d1526] rounded text-white" />
        </div>
        ...
        <div className="flex flex-wrap gap-4 p-4 bg-[#0d1a2e] rounded-xl border border-[#12233e]">
          ...
          <div className="flex bg-[#0d1526] rounded p-1">
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                <thead className="text-xs uppercase bg-gray-700/50 text-[#7a95b8]">
                  <tr><th className="px-4 py-2">Name</th><th className="px-4 py-2">Status</th><th className="px-4 py-2">AUM</th></tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">John Doe</td><td className="px-4 py-2 text-green-400">Active</td><td className="px-4 py-2">$1.2M</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Jane Smith</td><td className="px-4 py-2 text-yellow-400">Pending</td><td className="px-4 py-2">$850K</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Bob Johnson</td><td className="px-4 py-2 text-green-400">Active</td><td className="px-4 py-2">$3.4M</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                ...
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Total AUM</td><td className="px-4 py-2">$45.2M</td><td className="px-4 py-2 text-green-400">+5.2%</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">New Clients</td><td className="px-4 py-2">12</td><td className="px-4 py-2 text-green-400">+2</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Retention</td><td className="px-4 py-2">98%</td><td className="px-4 py-2 text-[#7a95b8]">0%</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                ...
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Annual Review</td><td className="px-4 py-2">Today</td><td className="px-4 py-2 text-red-400">High</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Portfolio Rebalance</td><td className="px-4 py-2">Tomorrow</td><td className="px-4 py-2 text-yellow-400">Med</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Client Call</td><td className="px-4 py-2">Next Week</td><td className="px-4 py-2 text-green-400">Low</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                ...
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Oct 12</td><td className="px-4 py-2">Deposit</td><td className="px-4 py-2 text-green-400">+$50,000</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Oct 10</td><td className="px-4 py-2">Withdrawal</td><td className="px-4 py-2 text-red-400">-$5,000</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">Oct 05</td><td className="px-4 py-2">Fee</td><td className="px-4 py-2 text-red-400">-$150</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                ...
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">ALT-101</td><td className="px-4 py-2 text-red-400">Critical</td><td className="px-4 py-2">Open</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">ALT-102</td><td className="px-4 py-2 text-yellow-400">Warning</td><td className="px-4 py-2">Investigating</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">ALT-103</td><td className="px-4 py-2 text-blue-400">Info</td><td className="px-4 py-2">Closed</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="rc-card bg-[#0d1a2e] p-4 rounded-xl border border-[#12233e]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-[#7a95b8]">
                ...
                <tbody>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">10:45 AM</td><td className="px-4 py-2">Login</td><td className="px-4 py-2">admin</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">11:20 AM</td><td className="px-4 py-2">Data Export</td><td className="px-4 py-2">jdoe</td></tr>
                  <tr className="border-b border-[#1e3a5f]"><td className="px-4 py-2">01:15 PM</td><td className="px-4 py-2">Settings Updated</td><td className="px-4 py-2">admin</td></tr>
                </tbody>
              </table>
            </div>
          </div>
