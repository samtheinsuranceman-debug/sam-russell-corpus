  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-300 p-6 lg:p-10">
      ...
      <p className="mb-8 max-w-3xl">
        Trusts are foundational tools for estate planning, offering unparalleled asset protection and control over wealth distribution. At Russell Capital Solutions, we integrate trust strategies with innovative investments to build lasting legacies. Dive into the sections below to understand how trusts can secure your financial future.
      </p>
      ...
      <div className="bg-[#1e293b] rounded-lg shadow-lg p-6">
        {activeTab === 0 && (
          <div>
            ...
            <p>
              At Russell Capital Solutions, our AI Strategy Engine evaluates your estate size, tax exposure, and family needs to recommend the ideal trust structure. We model scenarios like the 2026 estate tax sunset to ensure your plan remains robust under changing laws. Partner with us to craft a trust strategy that protects your wealth and aligns with your long-term vision.
            </p>
          </div>
        )}
        {activeTab === 1 && (
        ...
        {activeTab === 2 && (
          <div>
            ...
            <p>
              Russell Capital Solutions’ AI Strategy Engine models oil and gas investments within trusts, optimizing IDC deductions and income distributions for tax efficiency. We align these strategies with broader estate planning goals, ensuring compliance with IRS regulations. Partner with us to integrate oil and gas into your trust for enhanced wealth protection and legacy building.
            </p>
          </div>
        )}
        {activeTab === 3 && (
