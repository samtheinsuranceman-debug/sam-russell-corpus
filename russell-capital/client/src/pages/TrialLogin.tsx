        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-400 text-base leading-relaxed">
              Access the full power of Russell Capital Solutions™' Enterprise suite — every calculator, 
          ...
          <Card className="bg-[#111c32]/80 border-amber-600/50 backdrop-blur-sm">
            ...
            <CardContent className="space-y-5">
              <div className="bg-amber-500/10 border border-amber-600/30 rounded-lg p-4">
                <h4 className="text-amber-400 font-semibold mb-1">Russell Capital Solutions™ — Advisor Portal</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-[#0a1628] border-slate-600 text-white placeholder:text-slate-500 focus:border-emerald-500"
                  />
                  <p className="text-xs text-slate-500">Contact your Russell Capital Solutions™ representative for the access password</p>
                </div>
