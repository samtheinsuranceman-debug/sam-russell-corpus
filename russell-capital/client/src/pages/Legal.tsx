...
export function Privacy() {
  return (
    <LegalShell title="Privacy Policy">
      ...
      <p>Russell Capital Solutions™ ("we", "our", "us") operates the Russell Capital Solutions™ Wealth OS platform. www.RussellCapitalSystems.com is owned and operated by Russell Holdings Management LLC. This Privacy Policy explains how we collect, use, and protect your information.</p>
...
export function Terms() {
  return (
    <LegalShell title="Terms of Service">
      <p><strong className="text-white">Effective Date:</strong> January 1, 2026</p>
      <p>By accessing or using the Russell Capital Solutions™ Wealth OS platform, you agree to these Terms of Service.</p>
      ...
      <p>All platform software, models, and content are the intellectual property of Russell Holdings Management LLC, doing business as Russell Capital Solutions™. You may not reverse-engineer, copy, or redistribute any platform components. Unauthorized access, scraping, or reproduction of any proprietary content is strictly prohibited and may result in legal action.</p>
      <h2 className="text-white font-bold text-lg">Contact</h2>
...
export function Support() {
  return (
    <LegalShell title="Support">
      <p>Our support team is available to help you get the most out of Russell Capital Solutions™ Wealth OS.</p>
