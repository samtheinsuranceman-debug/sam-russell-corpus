...
const MatchAndDeployPage: React.FC = () => {
  ...
  const [yearsToRetirement, setYearsToRetirement] = useSharedField("projectionYears", 25);
  const [currentTaxBracket, setCurrentTaxBracket] = useSharedField("currentTaxBracket", 37);
  const [retirementTaxBracket, setRetirementTaxBracket] = useSharedField("retirementTaxBracket", 32);
