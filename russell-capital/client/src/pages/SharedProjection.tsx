  ...
  return (
    <div className="min-h-screen bg-[#0a1628]">
      ...
      <header className="border-b border-[#1e3a5f] bg-[#0f2035]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-white font-semibold">Russell Capital Solutions™</div>
      ...
      <footer className="border-t border-[#1e3a5f] bg-[#0f2035] mt-12">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="text-[#7a95b8] text-xs">Russell Capital Solutions™ — Confidential Client Projection</div>
