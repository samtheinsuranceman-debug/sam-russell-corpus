  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-white p-6">
      ...
      <footer className="mt-8 text-center text-gray-500 text-sm">
        <p>
          Russell Capital Solutions tools are for informational use only. Annuity products carry risks and are not FDIC insured. Consult a professional advisor for guidance.
        </p>
      </footer>
    </div>
  );
