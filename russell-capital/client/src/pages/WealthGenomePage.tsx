  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-white p-6">
      <header className="mb-6">
        ...
        <p className="text-gray-400">8-Dimension Financial Health Score (Double-Helix Model)</p>
      </header>
      ...
      <footer className="mt-8 text-center text-gray-500 text-sm">
        <p>
          Russell Capital Solutions provides tools for informational purposes only. Not intended as financial advice. Consult a qualified professional for personalized guidance.
        </p>
      </footer>
    </div>
  );
