...
import { Eye, EyeOff, Lock, AlertCircle, CheckCircle2, Check } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
            ...
            {success ? (
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  <div>
                    <p className="text-emerald-300 text-sm font-medium">Password updated!</p>
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          &copy; {new Date().getFullYear()} Russell Capital Solutions™ &bull; www.RussellCapitalSystems.com
        </p>
      </div>
    </div>
  );
