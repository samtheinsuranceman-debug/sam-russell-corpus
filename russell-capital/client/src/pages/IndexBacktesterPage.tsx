    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <footer className="text-gray-500 text-sm mt-6">
          <p>Regulatory Disclaimer: Russell Capital Solutions provides tools for life & annuity agents only. Not for use by series-licensed professionals. Backtest results are not indicative of future performance. Consult financial advisors for strategy implementation.</p>
        </footer>
      </div>
    </div>
  );
