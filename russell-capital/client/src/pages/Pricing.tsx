    ...
    <div className="min-h-screen bg-[#060f20] text-[#c8d8ec]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#c8d8ec] leading-relaxed">
                    ...
                    By subscribing to any Russell Capital Solutions™ plan, you acknowledge and agree that all charges are final and no refunds
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <p className="text-[10px] text-[#7a95b8]/60 text-center leading-relaxed italic">
              * These figures are research-based estimates derived from independent industry research and published advisor productivity studies.
              ...
              Russell Holdings Management LLC d/b/a Russell Capital Solutions™. Past performance of other subscribers or research subjects is not indicative of future results.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-[#12233e]">
        <div className="container py-16 text-center">
          ...
          <p className="text-[#7a95b8] mb-8 max-w-lg mx-auto">Join hundreds of financial advisors using Russell Capital Solutions™ to grow their business with advanced tools.</p>
      ...
      <div className="border-t border-[#12233e] py-6">
        <div className="container text-center text-xs text-[#7a95b8] space-y-2">
          <p>Russell Holdings Management LLC d/b/a Russell Capital Solutions™. All plans include a 14-day free trial. Prices shown in USD.</p>
