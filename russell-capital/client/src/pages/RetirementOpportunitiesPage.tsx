  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-300 p-6 lg:p-10">
      ...
      <p className="mb-8 max-w-3xl">
        Planning for retirement requires innovative strategies to ensure financial security and growth. At Russell Capital Solutions, we leverage advanced tools like the AI Strategy Engine to identify personalized opportunities that maximize tax advantages and income potential. Explore the tabs below to discover proven methods for building a robust retirement portfolio.
      </p>
      ...
      <div className="bg-[#1e293b] rounded-lg shadow-lg p-6">
        ...
        {activeTab === 1 && (
          <div>
            ...
            <p className="mb-4">
              Fixed Indexed Annuities (FIAs) provide a secure path to guaranteed lifetime income with downside protection from market volatility. These products link growth to a market index like the S&P 500 while ensuring your principal is never at risk, making them a compelling alternative to bonds or CDs in a low-interest environment. Additionally, FIAs often include income riders that guarantee 5-7% rollup rates, compounding your income base regardless of market performance. At Russell Capital Solutions, our AI Strategy Engine analyzes FIA options to match your retirement timeline and income needs.
            </p>
            <p className="mb-4">
        ...
        {activeTab === 4 && (
          <div>
            ...
            <p className="mb-4">
              Retirees often have time and expertise to leverage for supplemental income, and Russell Capital Solutions identifies the top opportunities to build wealth in retirement. From short-term rental businesses averaging $14,000 per year in income (Airbnb data) to real estate buy-and-hold strategies, retirees can create steady cash flow with minimal effort. Other options, like REIT investing with 3-5% dividend yields or building a dividend portfolio of aristocrats, offer passive income without property management. Our AI Strategy Engine evaluates startup costs and income potential to match opportunities to your lifestyle.
            </p>
            <p className="mb-4">
