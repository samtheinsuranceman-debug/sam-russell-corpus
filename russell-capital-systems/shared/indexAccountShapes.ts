...
export const SHAPES_VERSION = {
  ...
  neverPrinted: [
    ...
    'A participation rate assumed to err on the safe side. Securian prints 105% on an account crediting at 1.47x and 110% on an account crediting at 0.84x — the field is wrong in both directions, so no conservative reading of it exists. See shared/securianBGA2Statement.ts.',
