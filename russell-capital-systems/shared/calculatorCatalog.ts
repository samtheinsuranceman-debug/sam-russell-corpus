...
export const CALCULATORS: readonly CalculatorEntry[] = [
  ...
  { path: "/portal/amt-calculator", name: "Alternative Minimum Tax", category: "tax",
    blurb: "How much you can exercise in incentive stock options before AMT starts, and what the bubble costs past it.",
    engine: "shared/amtEngine.ts", keywords: ["amt", "iso", "stock options", "bargain element", "preference"] },
