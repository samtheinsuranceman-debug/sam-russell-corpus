...
export const CALCULATORS: readonly CalculatorEntry[] = [
  ...
  { path: "/portal/mutual-carriers", name: "The Carrier Desk", category: "insurance", featured: true,
    blurb: "Where each carrier actually wins, what it costs to borrow against a policy there, whose underwriting is easiest, and who will take a card \u2014 with ownership stated precisely, because \"mutual\" gets used for three different things.",
    engine: "shared/mutualCarrierIntel.ts", keywords: ["carrier", "mutual", "iul", "policy loan", "wash loan", "participating loan", "underwriting", "am best", "ratings", "cost of insurance"] },
  { path: "/portal/plastic-to-cash", name: "Plastic to Cash", category: "insurance", featured: true,
    blurb: "Turn a credit line you cannot invest with into policy cash value you can — with every card's own agreement language, the carriers that actually accept a card, and the ways it goes wrong listed before anything it might earn.",
    engine: "shared/plasticToCash.ts", keywords: ["credit card", "0% apr", "intro apr", "premium", "cash advance", "liquidity", "participating loan", "wash loan", "arbitrage", "float"] },
