...
export const PAGE_RATINGS: readonly PageRating[] = [
  ...
  { path: "/portal/fia-top10", value: 7, frequency: 4, conditions: "Conservative appetite with a lump to place.", connectTo: ["Live: rate sheets dated; the ten move monthly.", "Genome: link from the fixed-rate strategies."] },
