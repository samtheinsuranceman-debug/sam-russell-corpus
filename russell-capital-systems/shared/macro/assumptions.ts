...
const T: Assumption[] = [
  ...
  { id: "liq.tx.holderFxPctPer100bn.CN", value: 0.6, unit: "% yuan per $100 bn", kind: "model-choice", source: "platform", asOf: "2026-09-19", basis: "A third of Japan's coefficient (liq.tx.holderFxPctPer100bn.JP), because a managed fixing absorbs most of the flow. No Chinese official figure is read." },
  { id: "liq.tx.holderFxCapPct.CN", value: 5, unit: "%", kind: "model-choice", source: "platform", asOf: "2026-09-19", basis: "The yearly yuan move the fixing regime has tolerated, as seen in FRED's DEXCHUS series. No Chinese official figure is read." },
  ...
  { id: "oil.adj.goldPctPer10pts", value: 4, unit: "% per 10 share points", kind: "model-choice", source: "platform", asOf: "2026-06-30", basis: "Yuan oil receipts are partly converted to gold; 10 points ≈ 100–150 t/yr of extra demand. A platform estimate: no Chinese exchange figure is read." },
...
const HOUSEHOLD_FACTOR_ROWS: Assumption[] = [
  ...
  // ─── Projection confidence horizons (owner's ask, 23 Sep 2026): how far a calculator can project with confidence ───
  { id: "projection.horizon.confident", value: 2, unit: "years", kind: "model-choice", source: "platform", asOf: "2026-09-23", basis: "The layer's measurable signals lead their targets by 3 to 24 months (MACRO_FACTORS and HOUSEHOLD_FACTORS horizonMonths, backtested in emergentPatterns.ts); nothing live reaches past two years, so two years is the furthest a projection rests on current readings." },
  { id: "projection.horizon.moderate", value: 10, unit: "years", kind: "model-choice", source: "platform", asOf: "2026-09-23", basis: "Years 3 to 10 rest on the sourced, dated rules in this table (rates, elasticities, priors) and on published long-run series; each carries an as-of date and a half-life by cadence (conf.halfLife.*), so they decay but stay citable. A ten-year window matches the longest published outlooks the sources carry (CBO ten-year baseline, Fed SEP longer run)." },
  { id: "projection.horizon.band", value: 30, unit: "years", kind: "model-choice", source: "platform", asOf: "2026-09-23", basis: "Years 11 to 30 rest on long-run averages only (the forty-year record in FACTORS.md); the platform reports them as a band between the 10th and 90th percentile of the bootstrap, never as a point. Beyond thirty years the shape of a projection is shown and no figure is cited." },
];
