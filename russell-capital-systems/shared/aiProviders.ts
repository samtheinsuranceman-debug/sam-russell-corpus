...
export const PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    suggestedModels: ["meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8", "Qwen/Qwen3-235B-A22B-fp8-tput"],
  ...
  },
  {
    ...
    suggestedModels: ["accounts/fireworks/models/llama4-maverick-instruct-basic", "accounts/fireworks/models/qwen3-235b-a22b"],
  ...
  },
  {
    ...
    defaultModel: "meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8",
    suggestedModels: ["meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8", "Qwen/Qwen3-235B-A22B"],
    keyPattern: /^[A-Za-z0-9]{20,}$/,
    keyHint: "A long alphanumeric string",
  ...
  },
  {
    ...
    suggestedModels: ["meta-llama/Llama-4-Maverick-17B-128E-Instruct", "Qwen/Qwen3-235B-A22B"],
    keyPattern: ALNUM,
    keyHint: "A long alphanumeric string",
  ...
  },
  {
    ...
    chatPath: "/chat/completions",
    defaultModel: "meta-llama/llama-4-maverick-17b-128e-instruct-fp8",
    suggestedModels: ["meta-llama/llama-4-maverick-17b-128e-instruct-fp8", "qwen/qwen3-235b-a22b-fp8"],
    keyPattern: /^sk_[A-Za-z0-9_-]{20,}$|^[A-Za-z0-9_-]{20,}$/,
    keyHint: "Starts with sk_",
    consoleUrl: "https://novita.ai/settings/key-management",
    role: "Cheap open-weight capacity for background jobs: transcript digests, batch summaries.",
  },
  {
    id: "hyperbolic",
    name: "Hyperbolic",
    ...
    suggestedModels: ["meta-llama/Llama-3.3-70B-Instruct", "Qwen/Qwen3-235B-A22B"],
  ...
  },
  {
    ...
    suggestedModels: ["llama3.3", "qwen3", "gemma3"],
    keyPattern: /.*/,
  ...
  // ─── Tier 4: Asia-Pacific labs (data-handling caution on each) ──────────
  {
    ...
    role: "Very long context windows at low cost.",
    caution: "Hosted in China. Confirm that is acceptable under your engagement terms before any client data reaches it.",
  },
  {
    id: "qwen",
    ...
    suggestedModels: ["qwen-max", "qwen-plus", "qwq-plus"],
    keyPattern: /^sk-[A-Za-z0-9]{20,}$/,
    keyHint: "Starts with sk-",
    consoleUrl: "https://bailian.console.alibabacloud.com",
    role: "Strong multilingual and numerical reasoning at low cost.",
    caution: "Hosted by Alibaba Cloud (international endpoint by default). Confirm data handling before client data reaches it.",
  },
  {
    id: "zhipu",
    name: "Z.ai (GLM)",
    ...
    keyPattern: /^[A-Za-z0-9]{20,}\.[A-Za-z0-9]{10,}$/,
    keyHint: "Two parts separated by a period",
    consoleUrl: "https://z.ai/manage-apikey/apikey-list",
    role: "Competitive coding and reasoning performance at a low price point.",
    caution: "Hosted in China. Confirm data handling before client data reaches it.",
  },
  {
    id: "minimax",
    name: "MiniMax",
    ...
    suggestedModels: ["MiniMax-M1", "MiniMax-Text-01"],
    keyPattern: /^eyJ[A-Za-z0-9._-]{20,}$|^[A-Za-z0-9._-]{20,}$/,
    keyHint: "A JWT-style token starting with eyJ",
    consoleUrl: "https://www.minimax.io/platform",
    role: "Million-token context for whole-file analysis.",
    caution: "Hosted outside the United States. Confirm data handling before client data reaches it.",
  },
  {
    id: "qianfan",
    ...
    keyPattern: /^bce-v3\/[A-Za-z0-9/_-]{20,}$|^[A-Za-z0-9/_-]{20,}$/,
    keyHint: "Starts with bce-v3/",
    consoleUrl: "https://console.bce.baidu.com/qianfan",
    role: "ERNIE family; relevant only for engagements that need it.",
    caution: "Hosted in China. Confirm data handling before client data reaches it.",
  },
  {
    id: "upstage",
 ...
 */
export const BANNED_PROVIDER_PATTERN = /deepseek/i;
