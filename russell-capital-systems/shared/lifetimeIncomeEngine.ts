import { federalBracketsFor } from "./advancedAnalytics";
/**
...
// Federal brackets from the versioned rule set for the current year
// (these were hand-typed 2024 tables still in use in tax year 2026).
const FEDERAL_BRACKETS_MFJ = federalBracketsFor("joint");
const FEDERAL_BRACKETS_SINGLE = federalBracketsFor("single");
