...
export const CLAIMS: readonly ClaimEntry[] = [
  ...
  { ref: 'SI-021', title: 'Extreme-Scenario Portfolio Stress Testing', status: 'partial',
    engine: 'shared/monteCarloEngine.ts', page: 'client/src/pages/portal/MarketScenarioStressTest.tsx',
    note: 'Renamed from "Quantum-Resistant", which the portfolio review called a misnomer — nothing about it concerns quantum computing. The extreme-scenario work is real and runs in the Monte Carlo with the policy floor and cap enforced per path. What is missing is a standalone surface with named historical shocks (1973, 2000, 2008, 2020, 2022) rather than distribution tails alone.' },
  ...
  { ref: 'SI-026', title: 'Regulatory Sandbox Simulation Environment', status: 'partial',
    engine: 'shared/taxRules.ts', page: 'client/src/pages/portal/Erosion.tsx',
    note: 'The review said it had no code behind it; that is no longer quite true. Tax rules are versioned by year with their revenue procedure, and the erosion engine already re-runs a plan under another year\'s law and seals the difference — which is the sandbox mechanism. What is missing is the surface: a screen where a reviewer edits a rule and watches every dependent figure move.' },
