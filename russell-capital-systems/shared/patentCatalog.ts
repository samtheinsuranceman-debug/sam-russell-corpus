...
export const CLAIMS: readonly ClaimEntry[] = [
  ...
  // ── The forty-two ──────────────────────────────────────────────────────
  { ref: 'SI-001', title: 'Dynamic IUL Illustration Compliance Engine', status: 'dropped',
    note: 'Portfolio review: "maximize persuasive impact within AG49" dropped — AG 49-A already prescribes the benchmark and the phrasing invites regulatory trouble.' },
  ...
  { ref: 'SI-021', title: 'Quantum-Resistant Portfolio Stress Testing', status: 'dropped',
    note: 'Portfolio review: crowded and misnamed. Fat-tail testing folded in as a dependent of PAT-013.' },
  ...
  { ref: 'SI-023', title: 'Real-Time Market Sentiment Integration for IUL Crediting', status: 'dropped',
    note: 'Portfolio review: open but unsupportable without a source meeting the sourcing rules.' },
  ...
  { ref: 'SI-026', title: 'Regulatory Sandbox Simulation Environment', status: 'dropped',
    note: 'Portfolio review: open but has no code behind it.' },
