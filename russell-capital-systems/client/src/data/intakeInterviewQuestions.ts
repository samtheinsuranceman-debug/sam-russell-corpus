...
export const INTERVIEW_STEPS: InterviewStep[] = [
  ...
  // 2026 limits: 401(k) $24,500, IRA $7,500 — IRS Notice 2025-67, https://www.irs.gov/pub/irs-drop/n-25-67.pdf, and https://www.irs.gov/newsroom/401k-limit-increases-to-24500-for-2026-ira-limit-increases-to-7500 (read 23 Sep 2026). Were $23,500 / $7,000.
  { key: "retirementContributions", section: "Retirement Planning", question: "Are they currently maxing out their retirement contributions? (2026 — 401k: $24,500, IRA: $7,500, catch-up if over 50) If not, how much are they contributing?", followUp: "Every dollar counts. " },
