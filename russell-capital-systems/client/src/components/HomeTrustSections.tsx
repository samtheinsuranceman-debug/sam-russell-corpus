...
export const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "What does \"protected in divorce\" mean?", a: "It's the general idea of positioning assets inside structures designed to be more resilient to divorce, lawsuits, or creditors. How much protection applies depends on your state and circumstances, and is confirmed by your professionals." },
  { q: "What are the proprietary engines?", a: "Sixty-eight planning technologies, built to coordinate strategies that most tools treat as separate islands. Fifty-seven are documented with a drafted patent application; the other eleven are built and working but not yet written up. No patent application is on file with the USPTO yet, so no patent protection exists. We built them ourselves; we have not seen them offered elsewhere." },
