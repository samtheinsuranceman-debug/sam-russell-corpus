...
export default function SeniorPartnerBand() {
  return (
    <section id="proof" aria-label="Experience and client retention" className="relative isolate flex min-h-[100svh] items-center overflow-hidden bg-[#03090a] py-24">
      ...
      <img src="/rcs-neon-b.webp" alt="Neon sign reading Financial & Tax Relief and Recovery for Physicians, Psychiatrists, & Surgeons over a green city at night" className="absolute inset-0 z-0 h-full w-full object-cover object-center max-md:object-contain max-md:object-top" loading="lazy" decoding="async" />
