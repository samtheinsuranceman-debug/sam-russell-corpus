  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-white p-6">
      ...
      <footer className="mt-8 text-center text-gray-500 text-sm">
        <p>
          Russell Capital Systems provides tools for informational purposes only. Not intended as financial advice. Consult a qualified professional for personalized guidance. MYGA products are not FDIC insured.
        </p>
      </footer>
    </div>
  );
