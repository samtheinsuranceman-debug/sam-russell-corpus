...
export default function UltraCalculatorPage() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 px-4 py-10 text-slate-100">
      <PageBackdrop src="/rcs-city-skyway.webp" phoneSrc="/rcs-city-flagship.webp" alt="Green-lit skyline at night with a lit highway sweeping through the city" fade="#020617" />
