            ...
            return (
              <div className="mt-3 space-y-3">
                ...
                <div className="grid gap-2 md:grid-cols-3 text-xs">
                  ...
                  <div className="rounded-xl border border-white/10 p-3"><p className="text-slate-400">Governors · state legislatures · mayors</p>{n.governors ? <p className="text-lg font-semibold text-white">{n.governors.dem} D · {n.governors.rep} R <span className="text-xs font-normal text-slate-500">governors, {pct(n.governors.share, 0)} Democratic · Wikidata · {n.governors.asOf}</span></p> : <p className="text-slate-500">governors: no reading yet (Wikidata, keyless)</p>}<p className="text-slate-500">Legislatures and mayors are read by the AI council from NCSL and city records through the harvest path, quote-verified, approved by the owner.</p></div>
                </div>
