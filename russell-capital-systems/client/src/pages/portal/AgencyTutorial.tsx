...
const WELCOME_SLIDES = [
  ...
  {
    id: "w3",
    title: "The Russell Capital Systems™ Agency Solution",
...
,
  {
    ...
    timeToLearn: "12 min",
    description: "Leads are different from clients — they haven't bought yet. Upload your lead lists (seminar attendees, mailer responses, web inquiries) and Russell Capital Systems™ scores them, prioritizes them, and can auto-assign them to the right advisor based on expertise and capacity.",
...
,
  {
    ...
    drillDowns: [
      ...
      { id: "d5-3", title: "Certification Tracking", content: "When an advisor completes the tutorial with 80%+ score, they earn a 'Russell Capital Systems™ Certified' badge. Use this as a milestone in your onboarding process. 'Complete certification before week 3.'" },
    ],
  }
];
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        {showBadgePopup && (
          <div className="fixed top-20 right-6 z-50 animate-in slide-in-from-right fade-in duration-500">
            <div className="bg-zinc-800 border border-amber-500/30 rounded-2xl p-6 shadow-2xl shadow-amber-500/20 max-w-xs">
