...
//
// Ported from russell-capital. Every leaf that still resolves against this
// build's route table is a link; every leaf whose page has not been migrated
// yet is a placeholder, so the tree carries the full taxonomy without a single
// dead link. When a later migration PR adds one of those pages, its entry
// becomes a link again and `server/navTree.test.ts` proves that it resolves.
//
// Ported on 2026-09-20 against 330 routes: 147 leaves link and
// 142 are placeholders awaiting their page.
