...
const MutualCarriersPage = lazy(() => import("./pages/portal/MutualCarriers"));
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/portal/mutual-carriers" component={gated(MutualCarriersPage, "/portal/mutual-carriers")} />
