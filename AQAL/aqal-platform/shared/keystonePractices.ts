...
export const KEYSTONE_PRACTICES: KeystonePractice[] = [
  ...
  // ─── Goal shelves (sections 8000+, shared/goalShelves) ─────────────────────
  // Two anchor protocols per shelf so a member's stated goal reaches the shelf
  // through the coach, the projections and the /goal pages. Each researchBasis
  // is the honest headline of the cluster it points to.
  {
    id: "goal-marriage-rituals", name: "Daily rituals of connection", section: "8002", librarySection: "Marriage — Daily Rituals of Connection — Small Moments, Shared Activities",
    evidence: "Moderate", lifts: ["interpersonal", "empathic", "emotion"],
    prescription: "One screen-free ten-minute conversation about each other's day, every day, plus one new or mildly challenging shared activity a week that you both chose.",
    horizon: "30 days to make it a habit; the effect compounds over years",
    researchBasis: "In newlywed observation studies, the playful, attentive quality of ordinary dinnertime moments predicted how much humour and affection a couple later showed in conflict — the mundane moments are the foundation of how couples fight.",
    goalKeywords: ["marriage", "husband", "wife", "spouse", "relationship", "partner", "couple"],
  },
  {
    id: "goal-marriage-demand-withdraw", name: "Breaking demand–withdraw", section: "8005", librarySection: "Marriage — Communication — Breaking the Demand–Withdraw Pattern",
    evidence: "Strong", lifts: ["interpersonal", "self-regulation", "emotion"],
    prescription: "Before raising a complaint, write one sentence that states the request without criticism; if you are the one who shuts down, name a twenty-minute pause and come back to it.",
    horizon: "4–8 weeks of practice",
    researchBasis: "Demand–withdraw is the best-replicated communication marker of marital distress; meta-analysis links it consistently to lower satisfaction, and it is the pattern couples therapies target first.",
    goalKeywords: ["marriage", "husband", "wife", "spouse", "relationship", "partner", "couple", "conflict"],
  },
  {
    id: "goal-partner-what-predicts", name: "Judge by treatment, not the checklist", section: "8801", librarySection: "Finding a partner — What Actually Predicts a Good Relationship",
    evidence: "Strong", lifts: ["interpersonal", "intrapersonal", "decision-making"],
    prescription: "After each date, write two lines: how they treated you and others, and how you felt about yourself in their company. Weigh those over looks, résumé and the list.",
    horizon: "the next five dates",
    researchBasis: "The largest machine-learning study of relationship quality found the partner's perceived commitment, appreciation and responsiveness explained most of the predictable variance, while personality and attachment style explained little.",
    goalKeywords: ["dating", "find a partner", "soulmate", "settle down", "relationship", "single", "love"],
  },
  {
    id: "goal-partner-online-well", name: "Online dating, used well", section: "8802", librarySection: "Finding a partner — Where Couples Meet — Online Dating Used Well",
    evidence: "Strong", lifts: ["interpersonal", "volitional"],
    prescription: "Two apps at most, fifteen minutes of browsing a day, and any promising match moved to a real meeting within two weeks of first contact.",
    horizon: "60–90 days of intentional use",
    researchBasis: "Online dating is now the most common way US couples meet, and marriages that began online were slightly more satisfying and less likely to end early in a 19,131-person national sample; the harm shows up in endless browsing, not in meeting.",
    goalKeywords: ["dating", "find a partner", "soulmate", "settle down", "single", "love"],
  },
  {
    id: "goal-parenting-authoritative", name: "Warmth plus structure", section: "8101", librarySection: "Parenting — Parenting Style — Warmth Plus Structure",
    evidence: "Strong", lifts: ["interpersonal", "empathic", "self-regulation"],
    prescription: "Write the three non-negotiable rules of your home and the three ways your child knows you are on their side; say both out loud to them and re-read monthly.",
    horizon: "monthly, for years",
    researchBasis: "Since Baumrind's observations, adolescents who describe their parents as both demanding and responsive show the strongest competence and the least substance use and distress; each other pattern does worse.",
    goalKeywords: ["parent", "parenting", "kids", "children", "father", "mother", "family"],
  },
  {
    id: "goal-parenting-read-aloud", name: "Read aloud, dialogically, every day", section: "8102", librarySection: "Parenting — Talk, Read & Serve-and-Return — the Language Environment",
    evidence: "Strong", lifts: ["linguistic", "interpersonal", "cognition"],
    prescription: "One book with your child every day at the same time, with at least three open questions per book; tally it on the fridge and aim for 25 of 30 days.",
    horizon: "30 days to build the habit; the language gains accrue over years",
    researchBasis: "Meta-analyses find parent–preschooler shared reading explains about 8% of variance in language and later reading (d ≈ .59), with the dialogic style — asking, expanding, handing the story to the child — doing the most.",
    goalKeywords: ["parent", "parenting", "kids", "children", "father", "mother", "family", "reading"],
  },
  {
    id: "goal-legacy-letters", name: "The three-part legacy letter", section: "9204", librarySection: "Legacy — Legacy Letters & Ethical Wills — Preparation and Life Completion",
    evidence: "Moderate", lifts: ["reflective", "existential", "meaning"],
    prescription: "Over three weekends write a letter to the people who will outlive you: what your life has been, what you regret and forgive, and what you hope for them.",
    horizon: "three weekends",
    researchBasis: "The Outlook intervention — life review, forgiveness and regret, heritage and legacy, ending in a written legacy — improved functioning and preparation for life completion in its first randomized test; later trials were mixed, so the shelf rates it honestly.",
    goalKeywords: ["legacy", "memoir", "memorial", "life story", "remembered", "leave behind"],
  },
  {
    id: "goal-legacy-family-stories", name: "Tell the family stories", section: "9206", librarySection: "Legacy — Family Narratives — the Stories Grandchildren Carry",
    evidence: "Moderate", lifts: ["interpersonal", "linguistic", "meaning"],
    prescription: "One story about a parent or grandparent at one meal each week — the kind with good times, hard times and a way through — and ask the children to tell it back.",
    horizon: "weekly, for a month, then keep it",
    researchBasis: "Adolescents who know more of their family's history score higher on locus of control, self-esteem and family cohesion and lower on anxiety and behaviour problems; families who co-construct stories at the table pass that resilience on.",
    goalKeywords: ["legacy", "memoir", "memorial", "life story", "remembered", "grandkids", "family"],
  },
  {
    id: "goal-happiness-exercise", name: "Exercise as the first mood treatment", section: "8306", librarySection: "Happiness — Exercise — the Best-Evidenced Mood Treatment You Can Do Alone",
    evidence: "Strong", lifts: ["kinesthetic", "mood", "resilient"],
    prescription: "Three 30–45-minute sessions a week for eight weeks — brisk walking or jogging, strength or yoga — at an effort where talking is slightly hard, booked as appointments.",
    horizon: "8 weeks",
    researchBasis: "A 2024 network meta-analysis of 218 randomized trials found walking or jogging, yoga and strength training produced moderate reductions in depression, with more vigorous activity doing more.",
    goalKeywords: ["happy", "happiness", "wellbeing", "mood", "depression", "joy"],
  },
  {
    id: "goal-happiness-kindness", name: "Deliberate kindness and giving", section: "8304", librarySection: "Happiness — Kindness & Giving — Prosocial Spending and Acts",
    evidence: "Strong", lifts: ["interpersonal", "empathic", "mood"],
    prescription: "Three deliberate kind acts on one day each week for a month, and a small fixed monthly sum redirected from spending on yourself to spending on someone else.",
    horizon: "4 weeks",
    researchBasis: "A meta-analysis of experiments finds acts of kindness raise the actor's wellbeing with a small-to-medium effect, and randomized spending studies show giving to others produces more happiness than spending on oneself.",
    goalKeywords: ["happy", "happiness", "wellbeing", "mood", "joy", "meaning"],
  },
  {
    id: "goal-debt-order", name: "Pick one debt order and hold it", section: "8201", librarySection: "Debt — Debt Order — Snowball, Avalanche & Small Wins",
    evidence: "Moderate", lifts: ["financial-self-management", "volitional", "self-regulation"],
    prescription: "List every debt with balance and rate; choose one order — smallest balance first if you have stalled before, highest rate first if rates differ a lot — and put every extra dollar on the first account.",
    horizon: "the first account closed within 90 days",
    researchBasis: "Field and lab studies find that concentrating repayments into one account raises motivation and the share of debt repaid, because people read progress off the proportion of an account cleared; the cost of ignoring rates is real but usually smaller than the cost of quitting.",
    goalKeywords: ["debt", "credit card", "pay off", "owe", "loan", "money"],
  },
  {
    id: "goal-debt-autopay", name: "Automatic payments above the minimum", section: "8207", librarySection: "Debt — Autopay, Reminders & Present Bias",
    evidence: "Strong", lifts: ["financial-self-management", "volitional"],
    prescription: "Within two weeks, set an automatic payment on each debt for a fixed amount above the minimum, two days after payday, with a reminder the day before.",
    horizon: "2 weeks to set, then it runs",
    researchBasis: "Present-biased people carry more card debt and abandon their own paydown plans; commitment devices and reminders raise follow-through in field experiments, which is why automation beats willpower.",
    goalKeywords: ["debt", "credit card", "pay off", "owe", "loan", "money", "savings"],
  },
  {
    id: "goal-retirement-automate", name: "Enroll, match, escalate", section: "8401", librarySection: "Retirement — Automatic Enrollment & Escalation",
    evidence: "Strong", lifts: ["financial-self-management", "volitional"],
    prescription: "Confirm enrollment, contribute at least the full employer match, and switch on automatic annual escalation or write a dated rule to raise it one point at each raise.",
    horizon: "one week to set; decades to compound",
    researchBasis: "Automatic enrollment sharply raises participation and people stay at the default they are given; Save More Tomorrow showed employees who pre-commit to raise contributions with each pay rise end up saving far more.",
    goalKeywords: ["retire", "retirement", "401k", "invest", "wealth", "savings", "nest egg"],
  },
  {
    id: "goal-retirement-index", name: "Low-cost index core", section: "8403", librarySection: "Retirement — Fees & Index Investing",
    evidence: "Strong", lifts: ["financial-self-management", "decision-making"],
    prescription: "List every fund with its expense ratio; move broad-market holdings that cost more than a low-cost index equivalent into that equivalent and point new contributions there.",
    horizon: "one month",
    researchBasis: "From Jensen 1968 forward, the aggregate of actively managed funds underperforms after costs; Fama and French found few funds with enough skill to cover fees, and Carhart found little persistence beyond momentum and expenses.",
    goalKeywords: ["retire", "retirement", "401k", "invest", "wealth", "nest egg", "financial freedom"],
  },
  {
    id: "goal-business-scientific", name: "Test the business like a scientist", section: "8503", librarySection: "Business — Test Before You Build — The Scientific Approach and Lean Experimentation",
    evidence: "Strong", lifts: ["logical", "decision-making", "adaptive"],
    prescription: "Write the idea as a one-page theory with three falsifiable hypotheses about customers, price and channel; decide in advance what result would make you drop each, then run the cheapest test.",
    horizon: "4–8 weeks per round of tests",
    researchBasis: "Randomized trials of a scientific decision method for founders — theory, hypotheses, rigorous tests before committing — raised revenue and made founders more likely to pivot or exit bad ideas early.",
    goalKeywords: ["business", "startup", "entrepreneur", "founder", "company", "self-employed"],
  },
  {
    id: "goal-business-hybrid", name: "Hybrid entry — keep the income", section: "8502", librarySection: "Business — Keep the Day Job — Hybrid Entry and Founder Age",
    evidence: "Strong", lifts: ["volitional", "resilient", "financial-self-management"],
    prescription: "Start as a hybrid: keep your income, set a fixed weekly block of venture hours, and write the revenue or customer threshold at which you go full-time.",
    horizon: "6–18 months of hybrid work",
    researchBasis: "Large administrative-data studies find people who enter self-employment while keeping wage work, then transition, have better survival than those who leap directly — the 'burn the boats' story does not hold.",
    goalKeywords: ["business", "startup", "entrepreneur", "founder", "company", "self-employed", "side hustle"],
  },
  {
    id: "goal-hobby-skill-principles", name: "Practice by the learning sciences", section: "8603", librarySection: "Hobby & skill — How Skills Are Learned — Spacing, Retrieval, Feedback and Desirable Difficulty",
    evidence: "Strong", lifts: ["cognition", "memory", "volitional"],
    prescription: "Four short sessions a week instead of one long one; start each by attempting yesterday's material from memory; get one more-skilled person to watch you monthly.",
    horizon: "8–12 weeks",
    researchBasis: "Spacing beats massing, retrieval beats re-reading, and feedback plus desirable difficulty accelerates learning — principles that hold for chords, vocabulary and forehands alike.",
    goalKeywords: ["hobby", "skill", "learn", "instrument", "language", "practice"],
  },
  {
    id: "goal-hobby-serious-leisure", name: "Choose a serious leisure pursuit with a community", section: "8601", librarySection: "Hobby & skill — Leisure and Wellbeing — Serious Leisure and the Enjoyable-Activities Evidence",
    evidence: "Strong", lifts: ["interpersonal", "mood", "meaning"],
    prescription: "Write two hobbies you could still be doing in five years, pick the one with a local community, and book its first three sessions this week.",
    horizon: "this week to start; six months to belong",
    researchBasis: "Leisure engagement is moderately associated with subjective wellbeing across meta-analyses, and pursuits with perseverance, skill growth and a social world — serious leisure — carry the most.",
    goalKeywords: ["hobby", "skill", "learn", "instrument", "language", "friends", "lonely"],
  },
  {
    id: "goal-travel-short-breaks", name: "The quarterly four-night break", section: "9001", librarySection: "Travel — Short Breaks, Staycations & the Recovery Experiences That Make Them Work",
    evidence: "Strong", lifts: ["resilient", "mood", "recovery"],
    prescription: "Book one work-free four-night break in the next 60 days, away or at home, with out-of-office on and one restorative activity a day; repeat every quarter.",
    horizon: "quarterly",
    researchBasis: "A randomized trial of a four-night break in middle managers found large immediate gains in perceived stress, recovery and wellbeing whether the break was at a hotel or at home, still detectable weeks later.",
    goalKeywords: ["travel", "vacation", "trip", "abroad", "burnout", "stress"],
  },
  {
    id: "goal-travel-annual-rule", name: "The annual vacation rule", section: "9004", librarySection: "Travel — Vacation Frequency, Health & Mortality",
    evidence: "Moderate", lifts: ["resilient", "volitional", "healthspan"],
    prescription: "Write a ten-year rule you will not break: at least one work-free week a year, booked twelve months ahead and funded by an automatic monthly transfer.",
    horizon: "yearly, for a decade",
    researchBasis: "In 12,338 MRFIT men, more frequent annual vacations were associated with 17% lower all-cause and 29% lower cardiovascular mortality over nine years — observational, so the shelf rates it Moderate.",
    goalKeywords: ["travel", "vacation", "trip", "abroad", "see the world"],
  },
  {
    id: "goal-energy-exercise", name: "Movement as the energy treatment", section: "9301", librarySection: "Health, energy & beauty — Daily Energy — Exercise Is the First-Line Fatigue Treatment",
    evidence: "Strong", lifts: ["kinesthetic", "energy", "mood"],
    prescription: "Twenty minutes of easy movement three times a week for six weeks, at a talking pace, and a three-minute walk after every thirty minutes of sitting; rate your energy weekly.",
    horizon: "6 weeks",
    researchBasis: "A meta-analysis of 70 randomized trials found regular exercise increased feelings of energy and reduced fatigue — the most replicated counter-intuitive finding in exercise science.",
    goalKeywords: ["energy", "tired", "fatigue", "health", "vitality", "beauty"],
  },
  {
    id: "goal-beauty-sunscreen", name: "Daily sunscreen", section: "9307", librarySection: "Health, energy & beauty — Daily Sunscreen & the Sun Balance",
    evidence: "Strong", lifts: ["healthspan", "volitional"],
    prescription: "Broad-spectrum SPF 30+ on face, neck and hands every morning with brushing your teeth, year-round, reapplied before midday outdoor time.",
    horizon: "daily; visible in the four-year comparison",
    researchBasis: "The Nambour randomized trial of 903 adults found daily sunscreen users showed no detectable increase in skin aging over 4.5 years and 24% less than discretionary users, while beta-carotene did nothing.",
    goalKeywords: ["beauty", "skin", "look younger", "health", "vitality", "anti-aging"],
  },
];
