...
export const GOAL_SHELF_META: GoalShelfMeta[] = [
  ...
  { key: "legacy", label: "Memorialize a life in meaningful ways", short: "Legacy", base: 9200,
    keywords: ["legacy", "memorial", "memoir", "remember", "estate", "will", "generativity", "life story", "heirloom", "letters to", "leave behind"] },
  { key: "health-energy-beauty", label: "Great health, energy and beauty for as long as possible", short: "Health, energy & beauty", base: 9300,
    keywords: ["health", "healthy", "energy", "beauty", "skin", "hair", "look younger", "vitality", "fatigue", "tired", "weight", "fit"] },
  { key: "athlete", label: "Become a better athlete", short: "Athlete", base: 9400,
