...
build_matrix 101 "$tmp/101.tsv" 203 "$tmp/203.tsv" "$OUT_DIR/203_VS_101_MATRIX.tsv"
build_matrix 202 "$tmp/202.tsv" 203 "$tmp/203.tsv" "$OUT_DIR/203_VS_202_MATRIX.tsv"
build_matrix 203 "$tmp/203.tsv" current "$tmp/current.tsv" "$OUT_DIR/203_VS_CURRENT_MATRIX.tsv"

for matrix in "$OUT_DIR/203_VS_101_MATRIX.tsv" "$OUT_DIR/203_VS_202_MATRIX.tsv" "$OUT_DIR/203_VS_CURRENT_MATRIX.tsv"; do
