...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "Payments, the free founding spots, and the trial",
    a: "The first 1,000 founding members get the assessment and membership free for life — no card, ever. A signup reserves your spot for 14 days; completing the assessment claims it permanently. After the founding cohort, membership is $449/month or $4,499/year with a free trial, and premium assessments run $500–$1,500. Billing questions: the Support button reaches Sam directly." },
