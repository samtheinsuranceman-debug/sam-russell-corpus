# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-19

**Title of Invention:** Transparent Voice Coaching
...
**Combinator.** The combination executes as the `transparentVoiceCoaching` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
