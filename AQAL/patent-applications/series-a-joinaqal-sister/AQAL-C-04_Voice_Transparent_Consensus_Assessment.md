# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-04

**Title of Invention:** Voice-Transparent Consensus Assessment
...
**Combinator.** The combination executes as the `voiceTransparentConsensus` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
