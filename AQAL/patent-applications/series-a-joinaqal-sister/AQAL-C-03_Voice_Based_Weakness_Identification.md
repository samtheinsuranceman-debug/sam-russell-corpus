# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-03

**Title of Invention:** Voice-Based Weakness Identification
...
**Combinator.** The combination executes as the `voiceWeakness` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
