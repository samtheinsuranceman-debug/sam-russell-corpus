# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-11

**Title of Invention:** Transparent Integral Coaching
...
**Combinator.** The combination executes as the `transparentIntegralCoaching` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
