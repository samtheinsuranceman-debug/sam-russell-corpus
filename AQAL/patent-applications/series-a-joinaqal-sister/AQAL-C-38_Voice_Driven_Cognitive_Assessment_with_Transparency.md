# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-38

**Title of Invention:** Voice-Driven Cognitive Assessment with Transparency
...
**Combinator.** The combination executes as the `voiceCognitiveAssessmentTransparent` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
