# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-01

**Title of Invention:** Consensus-Driven Coaching Synthesis
...
**Combinator.** The combination executes as the `consensusDrivenCoaching` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
