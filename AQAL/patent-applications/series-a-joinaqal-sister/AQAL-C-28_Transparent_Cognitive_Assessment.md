# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-28

**Title of Invention:** Transparent Cognitive Assessment
...
**Combinator.** The combination executes as the `transparentCognitiveAssessment` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
