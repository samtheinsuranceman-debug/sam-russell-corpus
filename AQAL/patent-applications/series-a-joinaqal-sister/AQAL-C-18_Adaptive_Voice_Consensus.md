# DRAFT PROVISIONAL PATENT APPLICATION — AQAL-C-18

**Title of Invention:** Adaptive Voice Consensus
...
**Combinator.** The combination executes as the `adaptiveVoiceConsensus` combinator (server/patents/combinations/index.ts), registered in the sister-combination registry (server/patents/combinations/registry.ts) and invoked in the production scoring pass over the real outputs of each scoring run.
