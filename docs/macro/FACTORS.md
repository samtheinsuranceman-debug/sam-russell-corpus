...
Generated from `shared/macro/indicators.ts` (`MACRO_FACTORS`) by `server/macroFactorsDoc.ts`; macro layer 2026.09.22d; rendered 2026-09-22. Do not edit by hand — the test `server/macroW8.test.ts` compares this file with the renderer's output.
